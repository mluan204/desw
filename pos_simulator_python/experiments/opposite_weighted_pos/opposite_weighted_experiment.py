#!/usr/bin/env python3
"""
OPPOSITE_WEIGHTED PoS Experiment
Thí nghiệm với thuật toán OPPOSITE_WEIGHTED Proof-of-Stake
"""
...
foldername = 'opposite_weighted_pos'


def run_opposite_weighted_experiment(starting_gini=0.3, n_epochs=50000):
    """Chạy thí nghiệm OPPOSITE_WEIGHTED PoS"""
    print("OPPOSITE_WEIGHTED PoS EXPERIMENT")
    print("=" * 50)
    ...
    # In kết quả
    print_experiment_results("OPPOSITE_WEIGHTED PoS", gini_history, nakamoto_history, peers_history, hhi_history)
    
    # Vẽ và lưu các biểu đồ
    create_and_save_plot(gini_history, 'OPPOSITE_WEIGHTED PoS - Gini Coefficient Evolution', 
                        'Epoch', 'Gini Coefficient', 'opposite_weighted_gini.png', 'blue',foldername)
    
    create_and_save_plot(nakamoto_history, 'OPPOSITE_WEIGHTED PoS - Nakamoto Coefficient Evolution', 
                        'Epoch', 'Nakamoto Coefficient', 'opposite_weighted_nakamoto.png', 'red',foldername)
    
    create_and_save_plot(peers_history, 'OPPOSITE_WEIGHTED PoS - Peers Count Evolution', 
                        'Epoch', 'Number of Peers', 'opposite_weighted_peers.png', 'green',foldername)
    
    create_and_save_plot(hhi_history, 'OPPOSITE_WEIGHTED PoS - HHI Coefficient Evolution', 
                        'Epoch', 'HHI Coefficient', 'opposite_weighted_hhi.png', 'orange',foldername)
    ...
    save_results_to_json({0: result}, 'opposite_weighted_results.json',foldername)
...
def main():
    """Chạy thí nghiệm OPPOSITE_WEIGHTED PoS"""
    print("OPPOSITE_WEIGHTED PoS Simulator")
    print("=" * 60)
    ...
    try:
        ...
        # Chạy thí nghiệm
        result = run_opposite_weighted_experiment(starting_gini, n_epochs)
        
        print("\n" + "=" * 60)
        print("Thí nghiệm OPPOSITE_WEIGHTED PoS hoàn thành thành công!")
