#!/usr/bin/env python3
"""
SRSW_WEIGHTED PoS Experiment
Thí nghiệm với thuật toán SRSW_WEIGHTED Proof-of-Stake
"""
...
from pos_simulator_python.experiments.log_weighted_pos.log_weighted_experiment import foldername
...
foldername = 'srsw_weighted_pos'

def run_srsw_weighted_experiment(starting_gini=0.3, n_epochs=50000):
    """Chạy thí nghiệm SRSW_WEIGHTED PoS"""
    print("SRSW_WEIGHTED PoS EXPERIMENT")
    print("=" * 50)
    ...
    params = Parameters(
        n_epochs=n_epochs,
        proof_of_stake=PoS.SRSW_WEIGHTED,
    ...
    # In kết quả
    print_experiment_results("SRSW_WEIGHTED PoS", gini_history, nakamoto_history, peers_history, hhi_history)
    
    # Vẽ và lưu các biểu đồ
    create_and_save_plot(gini_history, 'SRSW_WEIGHTED PoS - Gini Coefficient Evolution', 
                        'Epoch', 'Gini Coefficient', 'srsw_weighted_gini.png', 'blue',foldername)
    
    create_and_save_plot(nakamoto_history, 'SRSW_WEIGHTED PoS - Nakamoto Coefficient Evolution', 
                        'Epoch', 'Nakamoto Coefficient', 'srsw_weighted_nakamoto.png', 'red',foldername)
    
    create_and_save_plot(peers_history, 'SRSW_WEIGHTED PoS - Peers Count Evolution', 
                        'Epoch', 'Number of Peers', 'srsw_weighted_peers.png', 'green',foldername)
    
    create_and_save_plot(hhi_history, 'SRSW_WEIGHTED PoS - HHI Coefficient Evolution', 
                        'Epoch', 'HHI Coefficient', 'srsw_weighted_hhi.png', 'orange',foldername)
    ...
    save_results_to_json({0: result}, 'srsw_weighted_results.json',foldername)
...
def main():
    """Chạy thí nghiệm SRSW_WEIGHTED PoS"""
    print("SRSW_WEIGHTED PoS Simulator")
    print("=" * 60)
    ...
    try:
        ...
        # Chạy thí nghiệm
        result = run_srsw_weighted_experiment(starting_gini, n_epochs)
        
        print("\n" + "=" * 60)
        print("Thí nghiệm SRSW_WEIGHTED PoS hoàn thành thành công!")
