...
Thí nghiệm với thuật toán WEIGHTED Proof-of-Stake
"""
...
foldername = 'weighted_pos'

def run_weighted_experiment(starting_gini=0.3, n_epochs=50000):
    """Chạy thí nghiệm WEIGHTED PoS"""
    ...
    # In kết quả
    print_experiment_results("WEIGHTED PoS", gini_history, nakamoto_history, peers_history, hhi_history)
    
    # Vẽ và lưu các biểu đồ
    create_and_save_plot(gini_history, 'WEIGHTED PoS - Gini Coefficient Evolution', 
                        'Epoch', 'Gini Coefficient', 'weighted_gini.png', 'blue',foldername)
    
    create_and_save_plot(nakamoto_history, 'WEIGHTED PoS - Nakamoto Coefficient Evolution', 
                        'Epoch', 'Nakamoto Coefficient', 'weighted_nakamoto.png', 'red',foldername)
    
    create_and_save_plot(peers_history, 'WEIGHTED PoS - Peers Count Evolution', 
                        'Epoch', 'Number of Peers', 'weighted_peers.png', 'green',foldername)
    
    create_and_save_plot(hhi_history, 'WEIGHTED PoS - HHI Coefficient Evolution', 
                        'Epoch', 'HHI Coefficient', 'weighted_hhi.png', 'orange',foldername)
    ...
    save_results_to_json({0: result}, 'weighted_results.json',foldername)
...
def main():
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("Thí nghiệm WEIGHTED PoS hoàn thành thành công!")
